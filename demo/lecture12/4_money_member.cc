...
class Money
{
  public:
    ...
    Money operator()(int theDollars);
    Money operator()(int theDollars, int theCents);
  private:
...
Money Money::operator()(int theDollars)
{
  dollars = theDollars;
}

Money Money::operator()(int theDollars, int theCents)
{
  dollars = theDollars;
  cents = theCents;
}
